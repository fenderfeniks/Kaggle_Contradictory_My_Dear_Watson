...
# ИНФРАСТРУКТУРА
IMAGE = Variable.get("PROJECT_IMAGE", default_var="my-company/kaggle_my_dear_watson:trainer-latest")
    ...
    train_model_task = KubernetesPodOperator(
        ...
        env_vars=[
            ...
            k8s.V1EnvVar(
                ...
                value_from=k8s.V1EnvVarSource(
                    secret_key_ref=k8s.V1SecretKeySelector(
                        name="my-dear-watson-api-secrets", key="KAGGLE_USERNAME"
                    )
                ),
            ),
            k8s.V1EnvVar(
                ...
                value_from=k8s.V1EnvVarSource(
                    secret_key_ref=k8s.V1SecretKeySelector(
                        name="my-dear-watson-api-secrets", key="KAGGLE_KEY"
                    )
                ),
            ),
        ],
